  ...
  <!-- <div class="form-elements-box"> -->
    ...
    <form action="" method="Post">
      ...
      <div class="form-row">
        ...
        <div class="form-row">
          <label for="contact-inquiry"><?php echo $label_inquiry; ?>*: </label>
          <textarea name="contact-inquiry" id="contact-inquiry" 
            cols="30" rows="5" placeholder="<?php echo $label_inquiry_placeholder; ?>" required aria-required="true"><?php echo $c_inquiry;?></textarea>
        </div>
        
        <div class="g-recaptcha"  name="g-recaptcha-response"  
          data-sitekey="<?php echo CAPTCHA_SITE_KEY?>"></div>
        
        <input type="submit" value="<?php echo $label_submit; ?>" name="submit">
